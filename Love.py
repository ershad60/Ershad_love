...
\033[1;93m ██╔══██║██╔═██╗░██║╚██╔╝██║
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║
\033[1;96m    ║✯𝔠𝔯𝔢𝔞𝔱𝔬𝔯   Ershad║    
\033[1;98m    ║✯ 𝔶𝔬𝔲𝔱𝔬𝔟 🖕❤❤❤   ║  
\033[1;96m    ║✯ 𝔱𝔢𝔩𝔢𝔤𝔯𝔞𝔪 :No🥰🥰
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
\033[1;95m___█───▄▀▀▀▀▄─▐█▌▐█▌▐██        
\033[1;95m___█──▐▄▄────▌─█▌▐█    ▐▌
\033[1;95m___█──▐█▀█─▀─▌─█▌▐█─▐██     By Ershad_hacker
\033[1;95m___█──▐████▄▄▌─▐▌▐▌─▐▌
\033[1;95m___███─▀████▀───██──▐██      Ershad HACKER
"""
...
def pilih_super():
	...
	jalan('           \033[1;91Ershad start cloning Wait...')
	print  "  \033[1;92m ●══════════════════◄►══════════════════●" 
	...
	print "  \033[1;91m«---•◈•---Developed By Ershad hacker--•◈•---»" #Dev:MOHAMMAD
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ....Ershad Creations....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91m Ershad"""
